This presents reproducibility and some code modifications/extensions on the paper below as the main goal in the seminar Advanced Machine Learning for Anomaly Detection.
...
## Prerequisites 
This code is written in `Python 3.10.13` and requires the packages listed in `requirements.txt`. Install with `pip install -r
